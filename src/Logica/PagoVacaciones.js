    ...
    async function loadEmployeeList() {
        ...
        try {
            ...
            if (validarpuesto == 94) {
                ...
                // Query similar pero para validarpuesto = 95
                query = `
                    SELECT
                        personal.Id AS IdPersonal,
                        CONCAT(personal.Primer_Nombre, ' ', IFNULL(personal.Segundo_Nombre, ''), ' ', 
                ...
                query = `
                    ...
                    FROM personal
                        ...
                        INNER JOIN puestos_general ON puestos.Id_PuestoGeneral = puestos_general.Id_Puesto
                    WHERE
            ...
            function renderEmployees(employees) {
                ...
                employees.forEach(employee => {
                    ...
                    if (!isCurrentUser) {
                        ...
                        row.title = 'No puedes solicitar pago de vacaciones para ti mismo';
